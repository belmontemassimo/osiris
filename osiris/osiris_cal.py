...
''' 
Functions:
get_calendar_events(start_date:datetime, end_date:datetime, calendar="UOE") -> list[tuple[str,datetime,datetime]]
add_calendar_event(start_date:datetime, end_date:datetime, event:str, calendar="osiris") -> None
clearCal(calendar="osiris") -> None
getFreeSlots(end_date:datetime, occupied_slots: list[str,datetime,datetime], work_start_time=time(10,00,00), work_end_time=time(19,30,00)) -> list[tuple[datetime,datetime]]
'''
    ...
    tell application "Calendar"
        ...
        try
            ...
            repeat with anEvent in theEvents
                if ((start date of anEvent) ≤ endDate and end date of anEvent ≥ startDate) then
...
def getFreeSlots(end_date:datetime, occupied_slots: list[str,datetime,datetime], work_start_time=time(10,00,00), work_end_time=time(19,30,00)) -> list[tuple[datetime,datetime]]:
    ...
    while current_date <= end_date:
        ...
        if current_date.date() == datetime.today().date() and current_date.time() > work_start_time:
